                ...
                return (
                    ...
                    >
                        <Input
                            ...
                            onChange={(event) => {
                                let newImplConfig = DeepCopy(implConfigs[type])
...
export const DeviceSchemaForm = (props: DeviceSchemaFormProps) => {
    ...
    const setImplConfig = (deviceType: string, impl_config: device["impl_config"]) => {
        let newImplConfigs = DeepCopy(implConfigs) as Record<string, device["impl_config"]>
    ...
    const buildEmptyImplConfigs = () => {
        ...
        let blankImplConfigs = {} as Record<string, device["impl_config"]>
